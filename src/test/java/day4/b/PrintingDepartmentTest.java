...
class PrintingDepartmentTest {
    @Test
    void should_return_zero_when_grid_is_empty() {
    ...
    @Test
    void should_allow_roll_with_three_adjacent_rolls() {
        PrintingDepartment department = PrintingDepartment.create();
    ...
    @Test
    void should_not_allow_roll_with_four_adjacent_rolls() {
        PrintingDepartment department = PrintingDepartment.create();
    ...
    @Test
    void should_count_diagonal_neighbors_as_adjacent() {
        PrintingDepartment department = PrintingDepartment.create();
    ...
    @Test
    void should_handle_edges_without_out_of_bounds() {
        PrintingDepartment department =  PrintingDepartment.create();
    ...
    @Test
    void should_count_only_accessible_rolls_in_mixed_grid() {
        PrintingDepartment department = PrintingDepartment.create();
    ...
    @Test
    void should_count_single_roll_as_accessible() {
        PrintingDepartment department = PrintingDepartment.create();
    ...
    @Test
    void should_return_zero_when_file_is_empty() throws Exception {
        PrintingDepartment department = PrintingDepartment.create();
    ...
    @Test
    void should_match_example_from_problem_statement_file() throws Exception {
        PrintingDepartment department = PrintingDepartment.create();
    ...
    @Test
    void should_count_single_roll_from_file() throws Exception {
        PrintingDepartment department = PrintingDepartment.create();
